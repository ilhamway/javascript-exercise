...
function ganjilGenap(plat) {
  ...
  if(plat === undefined || plat === null){
    ...
    if(ganjil > 0 && genap == 0){
      result = "plat ganjil sebanyak " + ganjil +  " dan plat genap tidak ditemukan"
    }else if(genap > 0 && ganjil == 0){
      result = "plat genap sebanyak " + genap + " dan plat ganjil tidak ditemukan"
    }else{
      result = "plat genap sebanyak " + genap + " dan plat ganjil sebanyak " + ganjil
    }
  }
